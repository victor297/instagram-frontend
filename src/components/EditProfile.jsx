  ...
  const EditHandler = async (e) => {
    ...
    try {
      ...
      if (file) {
        ...
        formDataFile.append("upload_preset", "instagram"); // Replace with your actual upload preset name

        try {
          const img = await axios.post(
            `https://api.cloudinary.com/v1_1/victor297/image/upload`,
            formDataFile
          );
